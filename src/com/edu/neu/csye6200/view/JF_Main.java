...
public class JF_Main extends JFrame {
	...
	public JF_Main() {
		...
		JI_Teacher_Maintain.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JF_MaintTeacher teacherManageInterFrm=new JF_MaintTeacher();
				teacherManageInterFrm.setVisible(true);
				table.add(teacherManageInterFrm);
			}
		});
		...
		JMenuItem JI_Manage_About = new JMenuItem("About");
		...
		menuItem_end.setIcon(new ImageIcon(JF_Main.class.getResource("/com/edu/neu/csye6200/images/end.png")));
